...
namespace RESTful_API.Controllers
{
    ...
    [ApiController]
    public class CodigosPostaisController : ControllerBase
    {
        private readonly PdsContext _context;

        public CodigosPostaisController(PdsContext context)
        {
            _context = context;
        }

        // GET: api/CodigosPostais
        [HttpGet]
